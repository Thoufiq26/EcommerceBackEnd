...
if (!process.env.MONGODB_URI || !process.env.AWS_ACCESS_KEY || !process.env.AWS_SECRET_KEY || !process.env.AWS_BUCKET) {
...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'https://ecommercefrontend-j99k.onrender.com'],
